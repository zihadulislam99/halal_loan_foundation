        ...
        <div className="container px-5 pt-24 pb-18 mx-auto">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">হালাল লোন ফাউন্ডেশন বাংলাদেশ</h2>
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Full address</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Address</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Email address</a>
                </li>
                <li>
